...
| Tool | Purpose |
|------|---------|
| `mcp__atuin_bash-history__atuin_search_history` | Fuzzy/prefix/full-text search with filtering by time, directory, exit code |
| `mcp__atuin_bash-history__atuin_get_recent_history` | Get N most recent commands |
| `mcp__atuin_bash-history__atuin_search_by_context` | Filter by git branch or Claude session ID |
| `mcp__atuin_bash-history__atuin_history_insights` | Stats on frequent commands and failure patterns |
