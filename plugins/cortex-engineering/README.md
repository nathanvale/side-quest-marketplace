...
```bash
claude plugin install cortex-engineering@cortex-engineering
```

## Commands

### `/cortex-engineering:research <topic>`
...
### `/cortex-engineering:brainstorm <topic>`
