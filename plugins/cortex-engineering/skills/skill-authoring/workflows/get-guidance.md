...
- Better as a slash command (user-triggered, fresh context)
...
These become the Core Principles section in SKILL.md.
...
### Step 7: Consider Router Upgrade

If the user has an existing simple skill that's growing complex, recommend upgrading to the router pattern:
- Move process content into workflows/
- Add Core Principles, Intake, and Routing sections to SKILL.md
- Create references/ for shared domain knowledge
...
1. **Yes, build it** - Switch to the create-new-skill workflow
2. **Adjust the plan** - Clarify and iterate
3. **Not yet** - Need to think more
