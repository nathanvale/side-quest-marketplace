...
View recent biome-runner log entries or filter by correlation ID.

## Usage

```
/biome-runner:logs [count|correlation-id]
```
...
```
/biome-runner:logs              # Last 20 entries
/biome-runner:logs 50           # Last 50 entries
/biome-runner:logs a1b2c3d4     # Filter by correlation ID
```
...
- Common fields: cid (correlation ID), hook, tool, durationMs, exitCode, errors, warnings
- Subsystem categories: biome-runner, biome-runner.biome, biome-runner.mcp
