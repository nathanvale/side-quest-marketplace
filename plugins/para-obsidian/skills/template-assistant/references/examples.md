...
**Recovery:** "I couldn't find template 'projectt'. Did you mean 'project'? Available templates: project, area, resource, task, capture, daily, weekly-review, booking, checklist, itinerary-day, trip-research."

### Missing Required Arg

**Error:** "Missing required argument: Area"

**Recovery:** "The project template requires an Area. Which area does this project belong to? Your current areas include: [[Work]], [[Health]], [[Family]], [[Learning]]."
