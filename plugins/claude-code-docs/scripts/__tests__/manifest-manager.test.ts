...
describe('ManifestManager', () => {
  ...
  describe('loadManifest', () => {
    test('loads existing manifest from file', async () => {
      ...
      expect(manifest.metadata.base_url).toBe('https://code.claude.com/docs/en')
  ...
  describe('needsUpdate', () => {
    test('returns true for new URL not in manifest', () => {
      ...
      const result = manager.needsUpdate('https://code.claude.com/docs/en/new', 'content', manifest)
    ...
    test('returns false when content hash is unchanged', () => {
      ...
      const result = manager.needsUpdate('https://code.claude.com/docs/en/hooks', content, manifest)
