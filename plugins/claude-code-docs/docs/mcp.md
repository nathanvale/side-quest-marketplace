...
[Plugins](plugins.md) can bundle MCP servers, automatically providing tools and integrations when the plugin is enabled. Plugin MCP servers work identically to user-configured servers. **How plugin MCP servers work**:
...
[Headless mode](headless.md)[Migrate to Claude Agent SDK](sdk/migration-guide.md)
