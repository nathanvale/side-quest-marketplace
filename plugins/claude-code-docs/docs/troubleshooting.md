...
If you find yourself repeatedly approving the same commands, you can allow specific tools to run without approval using the `/permissions` command. See [Permissions docs](iam.md#configuring-permissions).
...
For additional JetBrains configuration tips, see our [IDE integration guide](vs-code.md#jetbrains-plugin-settings).
...
[Migrate to Claude Agent SDK](sdk/migration-guide.md)
