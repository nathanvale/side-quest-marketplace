...
| **tsc-runner** | TypeScript checking | MCP: `mcp__plugin_tsc-runner_tsc-runner__tsc_check` |

## Utility Plugins

| Plugin | Purpose | Key Commands |
|--------|---------|--------------|
| **atuin** | Bash history search | MCP: `mcp__plugin_atuin_bash-history__atuin_search_history` |
